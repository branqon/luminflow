...
function MusicalWavesV2() {
  ...
  const runFlowStep = useCallback(() => {
    ...
    if (lineXRef.current[lineIndex] !== void 0) {
      spawnParticles(
  ...
  const movePoints = useCallback((time) => {
    ...
    linesRef.current.forEach((points) => {
      points.forEach((point) => {
        const drift = noise((point.x + time * 0.015) * 4e-3, (point.y + time * 0.01) * 3e-3) * 11;
        ...
        if (distance < influence) {
          ...
          const force = Math.cos(distance * 15e-4) * strength;
          point.cursor.vx += Math.cos(mouse.a) * force * influence * mouse.vs * 36e-5;
          point.cursor.vy += Math.sin(mouse.a) * force * influence * mouse.vs * 36e-5;
        }
  ...
  const drawFrame = useCallback(() => {
    ...
    lines.forEach((points, lineIndex) => {
      ...
      const hue = theme.baseHue + Math.sin(lineIndex * 0.08 + t * 2.5) * theme.hueSwing + lineIndex / Math.max(1, lines.length - 1) * theme.hueDrift;
      if (glow > 0.05 && zone) {
  ...
  useEffect(() => {
    if (!audioStarted || !guideVisible) return void 0;
    const timeoutId = window.setTimeout(() => setGuideVisible(false), 12e3);
    return () => clearTimeout(timeoutId);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "mw-backdrop" }),
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("canvas", { ref: mainCanvasRef, className: "mw-canvas" }),
      /* @__PURE__ */ React.createElement("canvas", { ref: glowCanvasRef, className: "mw-canvas mw-canvas-glow" }),
      /* @__PURE__ */ React.createElement(
        "div",
        {
          ref: cursorRef,
      ...
      /* @__PURE__ */ React.createElement("header", { className: "mw-header" }, /* @__PURE__ */ React.createElement("div", { className: "mw-card mw-top-card" }, /* @__PURE__ */ React.createElement("div", { className: "mw-label" }, "Musical Waves"), /* @__PURE__ */ React.createElement("h1", null, mood.label), /* @__PURE__ */ React.createElement("p", null, mood.tagline), /* @__PURE__ */ React.createElement("div", { className: "mw-chip-row" }, /* @__PURE__ */ React.createElement("span", { className: "mw-chip" }, currentRoot), /* @__PURE__ */ React.createElement("span", { className: "mw-chip" }, SCALES[currentScale].label), /* @__PURE__ */ React.createElement("span", { className: "mw-chip" }, ZONES[currentZone].label))), /* @__PURE__ */ React.createElement("div", { className: "mw-chip-row mw-chip-row-right" }, /* @__PURE__ */ React.createElement("span", { className: `mw-chip ${flowActive ? "active" : ""}` }, "Flow ", flowActive ? "On" : "Off"), /* @__PURE__ */ React.createElement("span", { className: `mw-chip ${droneActive ? "active warm" : ""}` }, "Drone ", droneActive ? "On" : "Off"))),
      /* @__PURE__ */ React.createElement("div", { className: "mw-zone-row" }, Object.keys(ZONES).map((zone) => /* @__PURE__ */ React.createElement(
        "span",
        {
          key: zone,
      ...
      guideVisible && audioStarted && /* @__PURE__ */ React.createElement("div", { className: "mw-guide" }, "Move left for lower notes, right for brighter notes. Slow drags bloom longer tones."),
      showPrompt && /* @__PURE__ */ React.createElement("div", { className: "mw-prompt-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "mw-card mw-prompt" }, /* @__PURE__ */ React.createElement("div", { className: "mw-label" }, "Ambient Instrument"), /* @__PURE__ */ React.createElement("h2", null, "Start with one sweep."), /* @__PURE__ */ React.createElement("p", null, "Drag anywhere to play. Hold on the field for a soft drone, or tap Flow for hands-free motion."), /* @__PURE__ */ React.createElement(
        "button",
        {
    ...
    /* @__PURE__ */ React.createElement("aside", { className: "mw-dock" }, /* @__PURE__ */ React.createElement("section", { className: "mw-card" }, /* @__PURE__ */ React.createElement("div", { className: "mw-label" }, "Mood Presets"), /* @__PURE__ */ React.createElement("div", { className: "mw-pill-row" }, Object.entries(MOODS).map(([key, preset]) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key,
      ...
      preset.label
    )))), /* @__PURE__ */ React.createElement("section", { className: "mw-card" }, /* @__PURE__ */ React.createElement("div", { className: "mw-label" }, "Pitch"), /* @__PURE__ */ React.createElement("div", { className: "mw-field-row" }, /* @__PURE__ */ React.createElement("label", { className: "mw-field" }, /* @__PURE__ */ React.createElement("span", null, "Key"), /* @__PURE__ */ React.createElement("select", { value: currentRoot, onChange: changeRoot }, ROOT_OPTIONS.map((root) => /* @__PURE__ */ React.createElement("option", { key: root, value: root }, root)))), /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "mw-pill-row" }, visibleScaleKeys.map((key) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key,
      ...
      SCALES[key].label
    )))), /* @__PURE__ */ React.createElement("section", { className: "mw-card" }, /* @__PURE__ */ React.createElement("div", { className: "mw-label" }, "Scene"), /* @__PURE__ */ React.createElement("div", { className: "mw-pill-row" }, /* @__PURE__ */ React.createElement("button", { className: `mw-button ${flowEnabled ? "active" : ""}`, onClick: toggleFlow }, "Flow"), /* @__PURE__ */ React.createElement("button", { className: `mw-button ${droneLatched ? "active warm" : ""}`, onClick: toggleDrone }, "Drone"), /* @__PURE__ */ React.createElement("button", { className: "mw-button", onClick: copyLink }, copyStatus === "copied" ? "Link Copied" : copyStatus === "failed" ? "Copy Failed" : "Share Link")), /* @__PURE__ */ React.createElement("p", { className: "mw-note" }, "Flow keeps the field moving on its own. Drone locks in a soft bed while you paint over it."))),
...
createRoot(rootEl).render(/* @__PURE__ */ React2.createElement(MusicalWavesV2, null));
